										...
										$.ajax({
                                            ...
                                            <div class="card-body" style="margin-top:-35px">
                                                <div class="row">
													...
													1. Подписаться на наш паблик, <a target="_blank" href="https://vk.com/svutiml">ссылка</a><br>
...
<div data-menu="menu-container" class="navbar-container main-menu-content container center-layout">
                    ...
                    <ul id="main-menu-navigation" data-menu="menu-navigation" class="nav navbar-nav">
						...
						<button style="margin-top:12px;float:right;" class="flat_button logo_button  color3_bg" onclick="window.open('https://vk.com/svutiml');">Мы Вконтакте</button>
                    </ul>
                </div>
